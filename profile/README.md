...
| Graphics | **g3d** | ✅ v0.1.0 | Pure Go 3D rendering — scene graph, PBR materials, forward renderer, 5 backends, ~12K LOC |
| Graphics | **gg-pdf** | ✅ Stable | PDF export backend for gg |
| Graphics | **gg-svg** | ✅ Stable | SVG export backend for gg |
| Application | **ui** | ✅ v0.1.1 | Enterprise GUI toolkit — 22 widgets, Material 3 / Fluent / Cupertino themes, DevTools, ~198K LOC |
