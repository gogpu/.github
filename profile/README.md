...
<p align="center">
  ...
  1.14M+ lines of code. GPU power, Go simplicity. Zero CGO.
</p>
...
| Graphics | **g3d** | ✅ v0.1.1 | Pure Go 3D rendering — scene graph, PBR materials, forward renderer, 5 backends, ~13K LOC |
| Graphics | **gg-pdf** | ✅ Stable | PDF export backend for gg |
| Graphics | **gg-svg** | ✅ Stable | SVG export backend for gg |
| Application | **ui** | ✅ v0.1.41 | Enterprise GUI toolkit — 24 widgets, Material 3 / Fluent / Cupertino / DevTools themes, Layer Tree compositor, ~207K LOC |
